...
torchrun --nproc_per_node 40 ./whisper/train.py \
  --max-duration 500 \
...
torchrun --nproc_per_node 2 ./whisper/train.py \
  --max-duration 1000 \
...
torchrun --nproc_per_node 4 ./whisper/train.py \
  --max-duration 300 \
  --exp-dir whisper/exp_large_v3_30 \
  --manifest-dir data/fbank_whisper \
  --base-lr 1e-6 \
  --model-name large-v3 \
--num-epochs 30 
...
def run(rank, world_size, args):
    ...
    train_dl = scc.train_dataloaders(train_cuts)
