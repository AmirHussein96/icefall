...
for epoch in 5 10; do
  python zipformer/decode_nohat.py \
    --epoch $epoch --avg 3 --use-averaged-model True \
    --beam-size 10 \
    --exp-dir zipformer/exp\
    --bpe-model data/lang_bpe_100/bpe.model \
    --max-duration 1000 \
    --num-encoder-layers 2,2,2 \
    --feedforward-dim 512,512,512 \
    --encoder-dim 256,256,256 \
    --num-heads 4,4,4 \
    --cnn-module-kernel 31,15,31 \
    --downsampling-factor 2,4,2 \
  --encoder-unmasked-dim 192,192,192 \
    --decoding-method modified_beam_search 
done
python zipformer_hat/decode_nohat.py \
    --epoch 10 \
        --avg 1 \
            --use-averaged-model True   \
                --beam-size 5       \
                    --causal 0    \
                        ...
                        --bpe-model data/lang_bpe_1000/bpe.model  \
                            --max-duration 1000  \
         ...
         --feedforward-dim 512  \
             --encoder-dim 256    \
                 --encoder-unmasked-dim 192 \
                     --decoding-method modified_beam_search
WER 53
python zipformer_hat/decode_nohat.py     --epoch 20         --avg 5 --use-averaged-model True                   --beam-size 10    --causal 0   --exp-dir zipformer_hat/exp_whisper_enc2     --bpe-model data/lang_bpe_1000/bpe.model  --max-duration 1000       --num-encoder-layers 2     --feedforward-dim 512  --encoder-dim 512      --encoder-unmasked-dim 192  --decoding-method modified_beam_search

# python zipformer_hat/decode_nohat.py     --epoch 20         --avg 5 --use-averaged-model True                   --beam-size 10    --causal 0   --exp-dir zipformer_hat/exp_whisper_enc3     --bpe-model data/lang_bpe_1000/bpe.model  --max-duration 1000       --num-encoder-layers 2     --feedforward-dim 512  --encoder-dim 512      --encoder-unmasked-dim 192  --decoding-method modified_beam_search
"""
...
from train_whisper_enc import add_model_arguments, get_model, get_params
...
def main():
    ...
    test_arzen = arzen.test_cuts()

    valid_dl = arzen.valid_dataloaders(arzen.valid_cuts())
    test_dl = arzen.test_dataloaders(arzen.test_cuts())
